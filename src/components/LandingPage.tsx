...
function BrandMark({ small = false }: { small?: boolean }) { return <div className={`${small ? "h-5 w-5 rounded-[6px] text-[10px]" : "h-[30px] w-[30px] rounded-[9px] text-[15px]"} flex shrink-0 items-center justify-center bg-gradient-to-br from-oa-primary to-[#1d4ed8] font-mono font-semibold text-oa-bg`}>৳</div>; }
